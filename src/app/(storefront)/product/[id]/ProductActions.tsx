    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 pt-4">
        ...
        <button
          ...
          disabled={!canSubmit}
          className="flex items-center justify-center gap-2 py-4 rounded-xl font-bold text-white bg-[#F26522] hover:bg-[#E85B1C] shadow-lg shadow-red-500/30 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
        >
