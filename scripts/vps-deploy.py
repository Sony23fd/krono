...
def main():
    ...
    try:
        ...
        run_ssh_command(ssh, f"cd {PROJECT_DIR} && docker compose exec web npx prisma@5.22.0 db push --skip-generate --accept-data-loss 2>&1 || docker-compose exec web npx prisma@5.22.0 db push --skip-generate --accept-data-loss 2>&1", timeout=120)
